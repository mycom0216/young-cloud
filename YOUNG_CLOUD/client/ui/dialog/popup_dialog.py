...
class BasePopup(QDialog):
    """모든 팝업창에서 공통으로 사용하는 상단-중앙-하단 3분할 레이아웃 베이스 클래스"""
...
class ReceiveMessagePopup(BasePopup):
    ...
    def init_content(self):
        # 상단 영역 추가 요소 (보낸 사람 정보)
        sender_label = QLabel("보낸 사람 : 관리자")
        ...
        self.msg_content_edit.setReadOnly(True)
        self.msg_content_edit.setText("안녕하세요. Young Cloud 시스템 공지 안내입니다.")
